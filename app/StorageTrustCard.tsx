...
export function StorageTrustCard({ spaceCount }: { spaceCount: number }) {
  ...
  return (
    <section className="suite-storage" aria-labelledby="suite-storage-title">
      <div className="suite-storage-intro">
        ...
        <h2 id="suite-storage-title">一处归属，每个私人空间各自收好。</h2>
        <p>
      ...
      <details className="suite-storage-details">
        ...
        <div className="suite-storage-grid">
          <article>
            <b>共同承受</b>
            <p>
              浏览器为这个完整地址留出的本地容量由这些空间共同使用。容量不足，或清除这个地址的资料，都可能同时影响它们。
            </p>
          </article>
          <article>
            <b>彼此独立</b>
          ...
          <article>
            <b>整套搬家</b>
            <p>
              想把整套资料带到另一个地址或浏览器资料，请从每个空间分别准备完整备份，现在一共需要 {spaceCount} 份。
            </p>
          </article>
        </div>
      </details>
