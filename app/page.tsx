  ...
  return (
    <main className="suite-home">
      ...
      <section className="suite-intro">
        ...
        <h1>三个空间，<br /><em>各自专注。</em></h1>
        <p>求职、学习与训练互不打扰。你的资料留在当前浏览器，真实记录不被分数和完成率取代。</p>
        <nav className="suite-shortcuts" aria-label="快速进入">
          <Link href="/career"><i>01</i><span>职迹</span></Link>
          <Link href="/vocab"><i>02</i><span>拾词</span></Link>
          <Link href="/fitness"><i>03</i><span>适练</span></Link>
        </nav>
      </section>
      <section className="suite-choices" aria-label="选择应用">
        <Link href="/career" className="suite-card suite-career">
          <header><span>01</span><b>求职进度与面经</b></header>
        ...
        <Link href="/vocab" className="suite-card suite-vocab">
          <header><span>02</span><b>文章与播客语境</b></header>
        ...
        <Link href="/fitness" className="suite-card suite-fitness">
          <header><span>03</span><b>真实器材训练规划</b></header>
      ...
      <footer className="suite-trust"><span><i>SQLite</i><b>三个独立本地数据库</b></span><p>清除浏览器站点数据仍会影响资料；请使用各应用内的完整备份。</p></footer>
    </main>
  );
}
